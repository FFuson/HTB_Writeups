...
**Cobertura:** 24 retos en 3 plataformas — 12 HackTheBox · 7 PortSwigger · 5 TryHackMe. 12 con writeup en español, 12 con writeup en vídeo.
...
1. **PortSwigger** — [Server-side template injection in a sandboxed environment](/portswigger/labs/server-side-template-injection/exploiting-server-side-template-injection-in-a-sandboxed-environment) (Apprentice) · 🇬🇧
2. **PortSwigger** — [Server-side template injection with a custom exploit](/portswigger/labs/server-side-template-injection/exploiting-server-side-template-injection-with-a-custom-exploit) (Apprentice) · 🇬🇧
3. **TryHackMe** — [OWASP Top 10 2025: Insecure Data Handling](/tryhackme/rooms/owasptopten2025three) (Easy · ~30 min) · 🇬🇧
4. **HackTheBox** — [Doctor](/htb/machines/linux/facil/doctor) (Fácil) · 🇪🇸 🇬🇧 📹
5. **HackTheBox** — [GoodGames](/htb/machines/linux/facil/goodgames) (Fácil) · 🇪🇸 🇬🇧 📹
6. **HackTheBox** — [Late](/htb/machines/linux/facil/late) (Fácil) · 🇪🇸 🇬🇧 📹
