...
**Cobertura:** 24 retos en 3 plataformas — 1 HackTheBox · 14 PortSwigger · 9 TryHackMe. 1 con writeup en español, 16 con writeup en vídeo.
...
2. **PortSwigger** — [Insecure direct object references](/portswigger/labs/access-control/insecure-direct-object-references) (Apprentice) · 🇬🇧 📹
3. **PortSwigger** — [Unprotected admin functionality](/portswigger/labs/access-control/unprotected-admin-functionality) (Apprentice) · 🇬🇧 📹
4. **PortSwigger** — [Unprotected admin functionality with unpredictable URL](/portswigger/labs/access-control/unprotected-admin-functionality-with-unpredictable-url) (Apprentice) · 🇬🇧 📹
5. **PortSwigger** — [User ID controlled by request parameter](/portswigger/labs/access-control/user-id-controlled-by-request-parameter) (Apprentice) · 🇬🇧 📹
6. **PortSwigger** — [User ID controlled by request parameter with data leakage in redirect](/portswigger/labs/access-control/user-id-controlled-by-request-parameter-with-data-leakage-in-redirect) (Apprentice) · 🇬🇧 📹
