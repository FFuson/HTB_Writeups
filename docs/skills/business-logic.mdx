...
description: "Recursos cross-platform para Business Logic Vulnerabilities: máquinas HTB y labs PortSwigger curados, con writeups validados y skills relacionadas."
---

# Business Logic Vulnerabilities

Esta página agrega los **recursos para practicar Business Logic Vulnerabilities** de forma cross-platform: máquinas retiradas de Hack The Box y labs de PortSwigger Web Security Academy, más recursos curados (HackTricks, PortSwigger, etc.) y skills relacionadas.
