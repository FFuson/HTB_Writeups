...
description: "Recursos cross-platform para Prototype Pollution: máquinas HTB y labs PortSwigger curados, con writeups validados y skills relacionadas."
---

# Prototype Pollution

Esta página agrega los **recursos para practicar Prototype Pollution** de forma cross-platform: máquinas retiradas de Hack The Box y labs de PortSwigger Web Security Academy, más recursos curados (HackTricks, PortSwigger, etc.) y skills relacionadas.
