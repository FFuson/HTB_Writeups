...
**Cobertura:** 17 retos en 3 plataformas — 4 HackTheBox · 8 PortSwigger · 5 TryHackMe. 4 con writeup en español, 11 con writeup en vídeo.
...
1. **PortSwigger** — [File path traversal, simple case](/portswigger/labs/file-path-traversal/simple) (Apprentice) · 🇬🇧 📹
2. **TryHackMe** — [Advent of Cyber 3 (2021)](/tryhackme/rooms/adventofcyber3) (Easy · ~1440 min) · 🇬🇧
3. **TryHackMe** — [Badbyte](/tryhackme/rooms/badbyte) (Easy · ~45 min) · 🇬🇧
4. **HackTheBox** — [Arctic](/htb/machines/windows/facil/arctic) (Fácil) · 🇪🇸 🇬🇧 📹
5. **HackTheBox** — [Blunder](/htb/machines/linux/facil/blunder) (Fácil) · 🇪🇸 🇬🇧 📹
6. **HackTheBox** — [ServMon](/htb/machines/windows/facil/servmon) (Fácil) · 🇪🇸 🇬🇧 📹
