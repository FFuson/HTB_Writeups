---
title: "SQL Injection"
description: "Recursos cross-platform para SQL Injection: máquinas HTB, labs PortSwigger y rooms TryHackMe curados, con writeups validados y skills relacionadas."
---
...
**Cobertura:** 78 retos en 3 plataformas — 36 HackTheBox · 22 PortSwigger · 20 TryHackMe. 36 con writeup en español, 36 con writeup en vídeo.
...
1. **PortSwigger** — [Detecting NoSQL injection](/portswigger/labs/nosql-injection/nosql-injection-detection) (Apprentice) · 🇬🇧
2. **PortSwigger** — [Exploiting NoSQL operator injection to bypass authentication](/portswigger/labs/nosql-injection/nosql-injection-bypass-authentication) (Apprentice) · 🇬🇧
3. **PortSwigger** — [SQL injection vulnerability allowing login bypass](/portswigger/labs/sql-injection/login-bypass) (Apprentice) · 🇬🇧
4. **PortSwigger** — [SQL injection vulnerability in WHERE clause allowing retrieval of hidden data](/portswigger/labs/sql-injection/retrieve-hidden-data) (Apprentice) · 🇬🇧
5. **TryHackMe** — [25 Days of Cyber Security](/tryhackme/rooms/learncyberin25days) (Easy · ~45 min) · 🇬🇧
6. **TryHackMe** — [Advent of Cyber 2 [2020]](/tryhackme/rooms/adventofcyber2) (Easy · ~45 min) · 🇬🇧
