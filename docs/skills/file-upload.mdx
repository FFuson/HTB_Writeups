...
description: "Recursos cross-platform para File Upload Vulnerabilities: máquinas HTB y labs PortSwigger curados, con writeups validados y skills relacionadas."
---

# File Upload Vulnerabilities

Esta página agrega los **recursos para practicar File Upload Vulnerabilities** de forma cross-platform: máquinas retiradas de Hack The Box y labs de PortSwigger Web Security Academy, más recursos curados (HackTricks, PortSwigger, etc.) y skills relacionadas.
...
| Lab | Topic | Oficial |
| --- | --- | --- |
| [Exploiting XXE via image file upload](/portswigger/labs/xxe/xxe-via-file-upload) | XXE (XML External Entity) | [Abrir](https://portswigger.net/web-security/xxe/lab-xxe-via-file-upload) |
...
| [Web shell upload via race condition](/portswigger/labs/file-upload/file-upload-web-shell-upload-via-race-condition) | File Upload Vulnerabilities | [Abrir](https://portswigger.net/web-security/file-upload/lab-file-upload-web-shell-upload-via-race-condition) |
