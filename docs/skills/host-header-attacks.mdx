...
description: "Recursos cross-platform para HTTP Host Header Attacks: máquinas HTB y labs PortSwigger curados, con writeups validados y skills relacionadas."
---

# HTTP Host Header Attacks

Esta página agrega los **recursos para practicar HTTP Host Header Attacks** de forma cross-platform: máquinas retiradas de Hack The Box y labs de PortSwigger Web Security Academy, más recursos curados (HackTricks, PortSwigger, etc.) y skills relacionadas.
