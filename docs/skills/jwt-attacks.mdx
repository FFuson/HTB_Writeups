...
**Cobertura:** 18 retos en 2 plataformas — 10 HackTheBox · 8 PortSwigger. 10 con writeup en español, 10 con writeup en vídeo.
...
1. **PortSwigger** — [JWT authentication bypass via algorithm confusion](/portswigger/labs/jwt/algorithm-confusion-jwt-authentication-bypass-via-algorithm-confusion) (Apprentice) · 🇬🇧
2. **PortSwigger** — [JWT authentication bypass via algorithm confusion with no exposed key](/portswigger/labs/jwt/algorithm-confusion-jwt-authentication-bypass-via-algorithm-confusion-with-no-exposed-key) (Apprentice) · 🇬🇧
3. **PortSwigger** — [JWT authentication bypass via flawed signature verification](/portswigger/labs/jwt/jwt-authentication-bypass-via-flawed-signature-verification) (Apprentice) · 🇬🇧
4. **PortSwigger** — [JWT authentication bypass via unverified signature](/portswigger/labs/jwt/jwt-authentication-bypass-via-unverified-signature) (Apprentice) · 🇬🇧
5. **HackTheBox** — [Secret](/htb/machines/linux/facil/secret) (Fácil) · 🇪🇸 🇬🇧 📹
6. **PortSwigger** — [JWT authentication bypass via jku header injection](/portswigger/labs/jwt/jwt-authentication-bypass-via-jku-header-injection) (Practitioner) · 🇬🇧
