...
**Cobertura:** 10 retos en 2 plataformas — 8 PortSwigger · 2 TryHackMe. 0 con writeup en español, 0 con writeup en vídeo.
...
1. **PortSwigger** — [Exploiting AI agents to exfiltrate sensitive information](/portswigger/labs/llm-attacks/ai-powered-scanner-vulnerabilities-sensitive-information-exfiltration) (Apprentice) · 🇬🇧
2. **PortSwigger** — [Exploiting AI agents to perform destructive actions](/portswigger/labs/llm-attacks/ai-powered-scanner-vulnerabilities-indirect-prompt-injection-via-ai-powered-scan) (Apprentice) · 🇬🇧
3. **PortSwigger** — [Exploiting insecure output handling in LLMs](/portswigger/labs/llm-attacks/exploiting-insecure-output-handling-in-llms) (Apprentice) · 🇬🇧
4. **PortSwigger** — [Exploiting LLM APIs with excessive agency](/portswigger/labs/llm-attacks/exploiting-llm-apis-with-excessive-agency) (Apprentice) · 🇬🇧
5. **TryHackMe** — [Advent of Cyber 2024](/tryhackme/rooms/adventofcyber2024) (Easy · ~1440 min) · 🇬🇧
6. **TryHackMe** — [CupidBot](/tryhackme/rooms/lafb2026e6) (Easy · ~60 min) · 🇬🇧
