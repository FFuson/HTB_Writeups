...
**Cobertura:** 25 retos en 3 plataformas — 10 HackTheBox · 11 PortSwigger · 4 TryHackMe. 10 con writeup en español, 18 con writeup en vídeo.
...
1. **PortSwigger** — [Basic SSRF against another back-end system](/portswigger/labs/ssrf/basic-ssrf-against-backend-system) (Apprentice) · 🇬🇧 📹
2. **PortSwigger** — [Basic SSRF against the local server](/portswigger/labs/ssrf/basic-ssrf-against-localhost) (Apprentice) · 🇬🇧 📹
3. **PortSwigger** — [Blind SSRF with Shellshock exploitation](/portswigger/labs/ssrf/blind-shellshock-exploitation) (Apprentice) · 🇬🇧 📹
4. **PortSwigger** — [Exploiting XXE to perform SSRF attacks](/portswigger/labs/xxe/exploiting-xxe-to-perform-ssrf) (Apprentice) · 🇬🇧
5. **PortSwigger** — [SSRF with whitelist-based input filter](/portswigger/labs/ssrf/ssrf-with-whitelist-filter) (Apprentice) · 🇬🇧 📹
6. **TryHackMe** — [Advent of Cyber 2023](/tryhackme/rooms/adventofcyber2023) (Easy · ~1440 min) · 🇬🇧
