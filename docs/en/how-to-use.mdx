...
<Steps>
  <Step title="1. Theory resources">
    Read [Learning resources](/en/recursos) and pick your platform:
  ...
  <Step title="2. Tactical glossary">
    Before touching a machine, open the [glossary](/en/glosario)
  ...
  <Step title="3. Professional methodology">
    Read [Methodology](/en/metodologia) — PTES phases, SMB/AD/Web
  ...
  <Step title="4. Combat (HTB)">
    Follow the [OSCP Roadmap](/en/roadmap-oscp) — 30 curated
  ...
  <Step title="5. Report your work">
    ...
    [Report template](/en/plantilla-informe). The 4 professional
  ...
  <Step title="6. Advanced specialization">
    ...
    [LLM Security](/en/llm-security), [Modern Red Team](/en/red-team-moderno),
...
<CardGroup cols={3}>
  ...
  <Card title="Methodology" icon="compass" href="/en/metodologia">
