...
{/* JSONLD:START */}
<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Professional web recon without firing the WAF","description":"Methodology for reconnaissance of corporate web applications with passive techniques and WAF evasion","inLanguage":"en","url":"https://rootea.es/en/web-recon"}`}</script>
{/* JSONLD:END */}
