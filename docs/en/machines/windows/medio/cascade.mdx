...
<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","headline":"Cascade — HTB Writeup Index","name":"Cascade","url":"https://rootea.es/en/machines/windows/medio/cascade","inLanguage":"en","datePublished":"2020-07-25","dateModified":"2026-05-08","about":{"@type":"Thing","name":"Hack The Box (HTB)"},"keywords":"Active Directory, Port Forwarding / Pivoting, Kerberoasting, GetNPUsers (Impacket), SQL Injection, SQL Injection, SMB (139/445)","isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"},"proficiencyLevel":"Medio"}`}</script>
