...
<div className="rootea-giscus-wrap" data-giscus-term="machine:flujab" data-giscus-lang="en"></div>

_Last updated: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","headline":"Flujab — HTB Writeup Index","name":"Flujab","url":"https://rootea.es/en/machines/linux/dificil/flujab","inLanguage":"en","datePublished":"2019-06-15","dateModified":"2026-05-08","about":{"@type":"Thing","name":"Hack The Box (HTB)"},"keywords":"SQL Injection, SQL Injection, SUID binaries, Remote Code Execution (RCE)","isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"},"proficiencyLevel":"Difícil"}`}</script>
