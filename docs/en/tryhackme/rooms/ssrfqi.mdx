...
| Average time | 30 min |
| Users | 142.710 |
| Official room | [Open](https://tryhackme.com/room/ssrfqi) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Open](https://tryhackme.com/room/ssrfqi) |
...
[Server-Side Request Forgery](/en/skills/ssrf) · [Remote Code Execution (RCE)](/en/skills/rce)
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-ssrfqi" data-giscus-lang="en"></div>

_Last updated: 2026-05-09_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Intro to SSRF","headline":"Intro to SSRF — TryHackMe room index","url":"https://rootea.es/en/tryhackme/rooms/ssrfqi","inLanguage":"en","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
