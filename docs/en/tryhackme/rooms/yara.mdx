...
| Users | 100.345 |
| Official room | [Open](https://tryhackme.com/room/yara) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Open](https://tryhackme.com/room/yara) |
| 🇬🇧 EN | **stuffy24** | Vídeo | [Open](https://youtu.be/uXpKr-ZGIp4) |
| 🇬🇧 EN | **stuffy24** | Vídeo | [Open](https://youtu.be/pnHWzXFTYwM) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-yara" data-giscus-lang="en"></div>

_Last updated: 2026-05-09_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Yara","headline":"Yara — TryHackMe room index","url":"https://rootea.es/en/tryhackme/rooms/yara","inLanguage":"en","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
