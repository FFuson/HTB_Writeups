...
| Users | 23.345 |
| Official room | [Open](https://tryhackme.com/room/breachingad) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Open](https://tryhackme.com/room/breachingad) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-breachingad" data-giscus-lang="en"></div>

_Last updated: 2026-05-09_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Breaching Active Directory","headline":"Breaching Active Directory — TryHackMe room index","url":"https://rootea.es/en/tryhackme/rooms/breachingad","inLanguage":"en","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
