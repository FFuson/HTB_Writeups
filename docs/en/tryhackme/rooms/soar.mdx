...
| Average time | 60 min |
| Users | 35.341 |
| Official room | [Open](https://tryhackme.com/room/soar) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Open](https://tryhackme.com/room/soar) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-soar" data-giscus-lang="en"></div>

_Last updated: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Introduction to SOAR","headline":"Introduction to SOAR — TryHackMe room index","url":"https://rootea.es/en/tryhackme/rooms/soar","inLanguage":"en","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
