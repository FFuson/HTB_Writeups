...
| Average time | 60 min |
| Users | 1.735 |
| Official room | [Open](https://tryhackme.com/room/supplementalmemory) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Open](https://tryhackme.com/room/supplementalmemory) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-supplementalmemory" data-giscus-lang="en"></div>

_Last updated: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Supplemental Memory","headline":"Supplemental Memory — TryHackMe room index","url":"https://rootea.es/en/tryhackme/rooms/supplementalmemory","inLanguage":"en","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
