...
| Average time | 75 min |
| Users | 5.173 |
| Official room | [Open](https://tryhackme.com/room/debug) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Open](https://tryhackme.com/room/debug) |
...
[Insecure Deserialization](/en/skills/insecure-deserialization)
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-debug" data-giscus-lang="en"></div>

_Last updated: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Debug","headline":"Debug — TryHackMe room index","url":"https://rootea.es/en/tryhackme/rooms/debug","inLanguage":"en","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Challenge"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
