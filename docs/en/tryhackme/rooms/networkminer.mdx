...
| Average time | 60 min |
| Users | 48.593 |
| Official room | [Open](https://tryhackme.com/room/networkminer) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Open](https://tryhackme.com/room/networkminer) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-networkminer" data-giscus-lang="en"></div>

_Last updated: 2026-05-09_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"NetworkMiner","headline":"NetworkMiner — TryHackMe room index","url":"https://rootea.es/en/tryhackme/rooms/networkminer","inLanguage":"en","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
