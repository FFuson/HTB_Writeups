...
| Users | 33.998 |
| Official room | [Open](https://tryhackme.com/room/linuxforensics) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Open](https://tryhackme.com/room/linuxforensics) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-linuxforensics" data-giscus-lang="en"></div>

_Last updated: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Linux Forensics","headline":"Linux Forensics — TryHackMe room index","url":"https://rootea.es/en/tryhackme/rooms/linuxforensics","inLanguage":"en","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
