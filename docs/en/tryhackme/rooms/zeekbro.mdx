...
| Users | 38.274 |
| Official room | [Open](https://tryhackme.com/room/zeekbro) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Open](https://tryhackme.com/room/zeekbro) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-zeekbro" data-giscus-lang="en"></div>

_Last updated: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Zeek","headline":"Zeek — TryHackMe room index","url":"https://rootea.es/en/tryhackme/rooms/zeekbro","inLanguage":"en","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
