...
{/* JSONLD:START */}
<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"DefinedTermSet","name":"Tactical pentesting glossary","description":"Operational pentesting dictionary for professional auditing and OSCP exam","inLanguage":"en","url":"https://rootea.es/en/glossary","creator":{"@type":"Organization","name":"rootea.es"}}`}</script>
{/* JSONLD:END */}
...
<div className="rootea-glosario-filter-wrap">
  <input
    ...
    placeholder="Filter terms (kerberos, lfi, ssrf, jwt…)"
    autoComplete="off"
    spellCheck="false"
  />
</div>
...
[`docs/en/glossary.mdx`](https://github.com/FFuson/HTB_Writeups/blob/main/docs/en/glossary.mdx)
