...
<div className="rootea-hero">
  ...
  <div className="rootea-hero-ctas">
    <a className="rootea-hero-cta rootea-hero-cta-primary" href="/en/all">
      Browse catalog →
    </a>
    <a className="rootea-hero-cta rootea-hero-cta-secondary" href="/en/random">
      🎲 Random machine
    </a>
    <a className="rootea-hero-cta rootea-hero-cta-secondary" href="/en/oscp-roadmap">
      OSCP+ roadmap
    </a>
  </div>
</div>
