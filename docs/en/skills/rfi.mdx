...
description: "Cross-platform resources for Remote File Inclusion (RFI): curated HTB machines, PortSwigger labs and TryHackMe rooms with validated writeups and related skills."
---
...
**Coverage:** 6 challenges across 2 platforms — 4 HackTheBox · 2 TryHackMe. 4 with a Spanish writeup, 5 with a video writeup.

## Where to start

Ordered by actual difficulty. At the same level: isolated lab first, then the guided room, and the full machine last.

1. **TryHackMe** — [File Inclusion](/en/tryhackme/rooms/fileinc) (Medium · ~60 min) · 🇬🇧 📹
2. **HackTheBox** — [Sniper](/en/htb/machines/windows/medio/sniper) (Medio) · 🇪🇸 🇬🇧 📹
3. **HackTheBox** — [StreamIO](/en/htb/machines/windows/medio/streamio) (Medio) · 🇪🇸 🇬🇧 📹
4. **HackTheBox** — [TartarSauce](/en/htb/machines/linux/medio/tartarsauce) (Medio) · 🇪🇸 🇬🇧 📹
5. **TryHackMe** — [The Bandit Surfer](/en/tryhackme/rooms/surfingyetiiscomingtotown) (Hard · ~120 min) · 🇬🇧
6. **HackTheBox** — [Fulcrum](/en/htb/machines/linux/insano/fulcrum) (Insano) · 🇪🇸 🇬🇧 📹
