...
**Coverage:** 78 challenges across 3 platforms — 36 HackTheBox · 22 PortSwigger · 20 TryHackMe. 36 with a Spanish writeup, 57 with a video writeup.

## Where to start

Ordered by actual difficulty. At the same level: isolated lab first, then the guided room, and the full machine last.

1. **PortSwigger** — [Detecting NoSQL injection](/en/portswigger/labs/nosql-injection/nosql-injection-detection) (Apprentice) · 🇬🇧
2. **PortSwigger** — [Exploiting NoSQL operator injection to bypass authentication](/en/portswigger/labs/nosql-injection/nosql-injection-bypass-authentication) (Apprentice) · 🇬🇧
3. **PortSwigger** — [SQL injection vulnerability allowing login bypass](/en/portswigger/labs/sql-injection/login-bypass) (Apprentice) · 🇬🇧 📹
4. **PortSwigger** — [SQL injection vulnerability in WHERE clause allowing retrieval of hidden data](/en/portswigger/labs/sql-injection/retrieve-hidden-data) (Apprentice) · 🇬🇧 📹
5. **TryHackMe** — [25 Days of Cyber Security](/en/tryhackme/rooms/learncyberin25days) (Easy · ~45 min) · 🇬🇧
6. **TryHackMe** — [Advent of Cyber 2 [2020]](/en/tryhackme/rooms/adventofcyber2) (Easy · ~45 min) · 🇬🇧 📹
