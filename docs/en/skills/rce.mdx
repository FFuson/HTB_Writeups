...
description: "Cross-platform resources for Remote Code Execution (RCE): curated HTB machines and PortSwigger labs with validated writeups and related skills."
---

# Remote Code Execution (RCE)

This page aggregates **cross-platform resources to practice Remote Code Execution (RCE)**: retired Hack The Box machines and PortSwigger Web Security Academy labs, plus curated resources (HackTricks, PortSwigger, etc.) and related skills.
...
## PortSwigger labs practicing Remote Code Execution (RCE) (4)
