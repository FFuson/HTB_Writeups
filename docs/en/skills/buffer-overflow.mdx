...
**Coverage:** 20 challenges across 2 platforms — 12 HackTheBox · 8 TryHackMe. 12 with a Spanish writeup, 13 with a video writeup.
...
2. **TryHackMe** — [Buffer Overflows](/en/tryhackme/rooms/bof1) (Easy · ~45 min) · 🇬🇧 📹
3. **TryHackMe** — [Flag Vault](/en/tryhackme/rooms/hfb1flagvault) (Easy · ~45 min) · 🇬🇧
4. **TryHackMe** — [Intro To Pwntools](/en/tryhackme/rooms/introtopwntools) (Easy · ~45 min) · 🇬🇧
5. **TryHackMe** — [Sudo Buffer Overflow](/en/tryhackme/rooms/sudovulnsbof) (Info · ~30 min) · 🇬🇧
6. **HackTheBox** — [Buff](/en/htb/machines/windows/facil/buff) (Fácil) · 🇪🇸 🇬🇧 📹
