...
description: "Cross-platform resources for Buffer Overflow (BoF / ROP): curated HTB machines and PortSwigger labs with validated writeups and related skills."
---

# Buffer Overflow (BoF / ROP)

This page aggregates **cross-platform resources to practice Buffer Overflow (BoF / ROP)**: retired Hack The Box machines and PortSwigger Web Security Academy labs, plus curated resources (HackTricks, PortSwigger, etc.) and related skills.
