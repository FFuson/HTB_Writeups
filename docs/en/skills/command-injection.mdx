...
**Coverage:** 27 challenges across 3 platforms — 17 HackTheBox · 5 PortSwigger · 5 TryHackMe. 17 with a Spanish writeup, 17 with a video writeup.

## Where to start

Ordered by actual difficulty. At the same level: isolated lab first, then the guided room, and the full machine last.

1. **PortSwigger** — [OS command injection, simple case](/en/portswigger/labs/os-command-injection/simple) (Apprentice) · 🇬🇧
2. **TryHackMe** — [Advent of Cyber 2022](/en/tryhackme/rooms/adventofcyber4) (Easy · ~1440 min) · 🇬🇧
3. **TryHackMe** — [Avengers Blog](/en/tryhackme/rooms/avengers) (Easy · ~30 min) · 🇬🇧
4. **TryHackMe** — [Command Injection](/en/tryhackme/rooms/oscommandinjection) (Easy · ~20 min) · 🇬🇧
5. **HackTheBox** — [Doctor](/en/htb/machines/linux/facil/doctor) (Fácil) · 🇪🇸 🇬🇧 📹
6. **HackTheBox** — [Netmon](/en/htb/machines/windows/facil/netmon) (Fácil) · 🇪🇸 🇬🇧 📹
