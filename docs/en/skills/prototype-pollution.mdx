...
description: "Cross-platform resources for Prototype Pollution: curated HTB machines and PortSwigger labs with validated writeups and related skills."
---

# Prototype Pollution

This page aggregates **cross-platform resources to practice Prototype Pollution**: retired Hack The Box machines and PortSwigger Web Security Academy labs, plus curated resources (HackTricks, PortSwigger, etc.) and related skills.
