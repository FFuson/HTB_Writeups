...
**Coverage:** 12 challenges across 1 platform — 12 PortSwigger. 0 with a Spanish writeup, 11 with a video writeup.
...
2. **PortSwigger** — [Excessive trust in client-side controls](/en/portswigger/labs/logic-flaws/examples-logic-flaws-excessive-trust-in-client-side-controls) (Apprentice) · 🇬🇧 📹
3. **PortSwigger** — [Flawed enforcement of business rules](/en/portswigger/labs/logic-flaws/examples-logic-flaws-flawed-enforcement-of-business-rules) (Apprentice) · 🇬🇧 📹
4. **PortSwigger** — [High-level logic vulnerability](/en/portswigger/labs/logic-flaws/examples-logic-flaws-high-level) (Apprentice) · 🇬🇧 📹
5. **PortSwigger** — [Inconsistent security controls](/en/portswigger/labs/logic-flaws/examples-logic-flaws-inconsistent-security-controls) (Apprentice) · 🇬🇧 📹
6. **PortSwigger** — [Authentication bypass via encryption oracle](/en/portswigger/labs/logic-flaws/examples-logic-flaws-authentication-bypass-via-encryption-oracle) (Practitioner) · 🇬🇧 📹
