...
description: "Cross-platform resources for Business Logic Vulnerabilities: curated HTB machines and PortSwigger labs with validated writeups and related skills."
---

# Business Logic Vulnerabilities

This page aggregates **cross-platform resources to practice Business Logic Vulnerabilities**: retired Hack The Box machines and PortSwigger Web Security Academy labs, plus curated resources (HackTricks, PortSwigger, etc.) and related skills.
