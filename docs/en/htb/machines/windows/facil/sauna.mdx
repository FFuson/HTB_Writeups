...
- [Forest](/en/htb/machines/windows/facil/forest) — Windows, Easy
...
<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","headline":"Sauna — HTB Writeup Index","name":"Sauna","url":"https://rootea.es/en/htb/machines/windows/facil/sauna","inLanguage":"en","datePublished":"2020-02-15","dateModified":"2026-06-07","about":{"@type":"Thing","name":"Hack The Box (HTB)"},"keywords":"Information Leakage, Cracking Hashes (hashcat / John), BloodHound, BloodHound, GetNPUsers (Impacket), AutoLogon credentials, winPEAS, DCSync","isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"},"proficiencyLevel":"Fácil"}`}</script>

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://rootea.es/en"},{"@type":"ListItem","position":2,"name":"Windows","item":"https://rootea.es/en/htb/machines/windows/facil/index"},{"@type":"ListItem","position":3,"name":"Easy","item":"https://rootea.es/en/htb/machines/windows/facil/index"},{"@type":"ListItem","position":4,"name":"Sauna","item":"https://rootea.es/en/htb/machines/windows/facil/sauna"}]}`}</script>
