...
<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","headline":"TimeLapse — HTB Writeup Index","name":"TimeLapse","url":"https://rootea.es/en/htb/machines/windows/facil/timelapse","inLanguage":"en","datePublished":"2022-08-20","dateModified":"2026-06-29","about":{"@type":"Thing","name":"Hack The Box (HTB)"},"keywords":"Information Leakage, Port Forwarding / Pivoting, SMB (139/445)","isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"},"proficiencyLevel":"Fácil"}`}</script>
