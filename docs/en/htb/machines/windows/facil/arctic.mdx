...
<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","headline":"Arctic — HTB Writeup Index","name":"Arctic","url":"https://rootea.es/en/htb/machines/windows/facil/arctic","inLanguage":"en","datePublished":"2020-05-19","dateModified":"2026-05-08","about":{"@type":"Thing","name":"Hack The Box (HTB)"},"keywords":"Directory / Path Traversal, Cracking Hashes (hashcat / John)","isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"},"proficiencyLevel":"Fácil"}`}</script>
