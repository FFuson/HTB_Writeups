...
<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","headline":"Atom — HTB Writeup Index","name":"Atom","url":"https://rootea.es/en/htb/machines/windows/medio/atom","inLanguage":"en","datePublished":"2021-07-10","dateModified":"2026-08-24","about":{"@type":"Thing","name":"Hack The Box (HTB)"},"keywords":"Redis Exploitation, SMB (139/445), Remote Code Execution (RCE)","isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"},"proficiencyLevel":"Medio"}`}</script>
