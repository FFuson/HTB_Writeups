...
<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","headline":"Json — HTB Writeup Index","name":"Json","url":"https://rootea.es/en/htb/machines/windows/medio/json","inLanguage":"en","datePublished":"2020-02-15","dateModified":"2026-05-08","about":{"@type":"Thing","name":"Hack The Box (HTB)"},"keywords":"Insecure Deserialization, Remote Code Execution (RCE)","isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"},"proficiencyLevel":"Medio"}`}</script>
