...
| [Altered](/en/htb/machines/linux/dificil/altered) | Brute Force / Rate-Limit Bypass · SQL Injection · Remote Code Execution (RCE) | 4 |
...
| [Falafel](/en/htb/machines/linux/dificil/falafel) | Information Leakage · SQL Injection | 3 |
| [Feline](/en/htb/machines/linux/dificil/feline) | Information Leakage · Port Forwarding / Pivoting · Remote Code Execution (RCE) | 4 |
...
| [Monitors](/en/htb/machines/linux/dificil/monitors) | Local File Inclusion (LFI) · Information Leakage · WordPress Exploitation · Remote Code Execution (RCE) | 4 |
| [Oouch](/en/htb/machines/linux/dificil/oouch) | Subdomain Enumeration · Information Leakage · Port Forwarding / Pivoting · Remote Code Execution (RCE) | 3 |
| [Overflow](/en/htb/machines/linux/dificil/overflow) | Buffer Overflow (BoF / ROP) · SQL Injection · Remote Code Execution (RCE) | 4 |
| [OverGraph](/en/htb/machines/linux/dificil/overgraph) | Subdomain Enumeration · Cross-Site Scripting (XSS) · Information Leakage · SQL Injection · Directory fuzzing · Server-Side Request Forgery · SUID binaries · Remote Code Execution (RCE) | 3 |
| [Oz](/en/htb/machines/linux/dificil/oz) | SQL Injection · Port Forwarding / Pivoting · Remote Code Execution (RCE) | 3 |
| [Phoenix](/en/htb/machines/linux/dificil/phoenix) | Cracking Hashes (hashcat / John) · SQL Injection · WordPress Exploitation | 3 |
| [Player](/en/htb/machines/linux/dificil/player) | Subdomain Enumeration · Information Leakage · Remote Code Execution (RCE) | 4 |
...
| [Talkative](/en/htb/machines/linux/dificil/talkative) | Information Leakage · Port Forwarding / Pivoting · Remote Code Execution (RCE) | 3 |
| [Tentacle](/en/htb/machines/linux/dificil/tentacle) | Active Directory | 3 |
| [Travel](/en/htb/machines/linux/dificil/travel) | WordPress Exploitation · Remote Code Execution (RCE) | 3 |
...
| [Unobtainium](/en/htb/machines/linux/dificil/unobtainium) | Local File Inclusion (LFI) · Information Leakage · Port Forwarding / Pivoting · Remote Code Execution (RCE) | 3 |
