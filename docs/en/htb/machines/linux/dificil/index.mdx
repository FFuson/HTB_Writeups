...
| [Dab](/en/htb/machines/linux/dificil/dab) | Cracking Hashes (hashcat / John) · Server-Side Request Forgery · SUID binaries · Directory fuzzing · Remote Code Execution (RCE) | 4 |
...
| [Overflow](/en/htb/machines/linux/dificil/overflow) | Buffer Overflow (BoF / ROP) · SQL Injection · Remote Code Execution (RCE) | 3 |
