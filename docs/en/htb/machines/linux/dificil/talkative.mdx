...
<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","headline":"Talkative — HTB Writeup Index","name":"Talkative","url":"https://rootea.es/en/htb/machines/linux/dificil/talkative","inLanguage":"en","datePublished":"2022-08-27","dateModified":"2026-05-08","about":{"@type":"Thing","name":"Hack The Box (HTB)"},"keywords":"Information Leakage, Port Forwarding / Pivoting, Remote Code Execution (RCE), File Upload Vulnerabilities","isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"},"proficiencyLevel":"Difícil"}`}</script>
