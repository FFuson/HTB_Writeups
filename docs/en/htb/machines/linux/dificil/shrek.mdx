...
<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","headline":"Shrek — HTB Writeup Index","name":"Shrek","url":"https://rootea.es/en/htb/machines/linux/dificil/shrek","inLanguage":"en","datePublished":"2020-07-22","dateModified":"2026-06-07","about":{"@type":"Thing","name":"Hack The Box (HTB)"},"keywords":"Information Leakage, Steganography (Stego), Port Forwarding / Pivoting","isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"},"proficiencyLevel":"Difícil"}`}</script>
