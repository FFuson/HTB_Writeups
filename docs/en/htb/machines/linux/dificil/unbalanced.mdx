...
<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","headline":"Unbalanced — HTB Writeup Index","name":"Unbalanced","url":"https://rootea.es/en/htb/machines/linux/dificil/unbalanced","inLanguage":"en","datePublished":"2020-12-05","dateModified":"2026-05-08","about":{"@type":"Thing","name":"Hack The Box (HTB)"},"keywords":"Information Leakage, Cracking Hashes (hashcat / John), Port Forwarding / Pivoting, Pi-hole credenciales por defecto, Remote Code Execution (RCE)","isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"},"proficiencyLevel":"Difícil"}`}</script>
