...
<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","headline":"Feline — HTB Writeup Index","name":"Feline","url":"https://rootea.es/en/htb/machines/linux/dificil/feline","inLanguage":"en","datePublished":"2021-02-20","dateModified":"2026-05-08","about":{"@type":"Thing","name":"Hack The Box (HTB)"},"keywords":"Information Leakage, Directory / Path Traversal, Port Forwarding / Pivoting, Remote Code Execution (RCE)","isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"},"proficiencyLevel":"Difícil"}`}</script>
