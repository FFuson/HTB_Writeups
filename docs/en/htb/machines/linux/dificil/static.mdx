...
<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","headline":"Static — HTB Writeup Index","name":"Static","url":"https://rootea.es/en/htb/machines/linux/dificil/static","inLanguage":"en","datePublished":"2021-12-18","dateModified":"2026-06-07","about":{"@type":"Thing","name":"Hack The Box (HTB)"},"keywords":"Port Forwarding / Pivoting, SUID binaries, Remote Code Execution (RCE)","isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"},"proficiencyLevel":"Difícil"}`}</script>
