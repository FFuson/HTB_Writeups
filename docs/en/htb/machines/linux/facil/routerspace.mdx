...
<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","headline":"RouterSpace — HTB Writeup Index","name":"RouterSpace","url":"https://rootea.es/en/htb/machines/linux/facil/routerspace","inLanguage":"en","datePublished":"2022-07-09","dateModified":"2026-06-07","about":{"@type":"Thing","name":"Hack The Box (HTB)"},"keywords":"linPEAS, Remote Code Execution (RCE)","isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"},"proficiencyLevel":"Fácil"}`}</script>
