...
<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","headline":"Ariekei — HTB Writeup Index","name":"Ariekei","url":"https://rootea.es/en/htb/machines/linux/insano/ariekei","inLanguage":"en","datePublished":"2022-04-20","dateModified":"2026-05-08","about":{"@type":"Thing","name":"Hack The Box (HTB)"},"keywords":"Shellshock (CVE-2014-6271), Shellshock (CVE-2014-6271), Port Forwarding / Pivoting","isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"},"proficiencyLevel":"Insano"}`}</script>
