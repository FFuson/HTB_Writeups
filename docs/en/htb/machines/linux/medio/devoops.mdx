...
<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","headline":"DevOops — HTB Writeup Index","name":"DevOops","url":"https://rootea.es/en/htb/machines/linux/medio/devoops","inLanguage":"en","datePublished":"2018-10-13","dateModified":"2026-07-13","about":{"@type":"Thing","name":"Hack The Box (HTB)"},"keywords":"XML External Entity, Information Leakage","isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"},"proficiencyLevel":"Medio"}`}</script>
