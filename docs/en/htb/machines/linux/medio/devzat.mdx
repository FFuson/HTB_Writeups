...
<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","headline":"Devzat — HTB Writeup Index","name":"Devzat","url":"https://rootea.es/en/htb/machines/linux/medio/devzat","inLanguage":"en","datePublished":"2022-03-12","dateModified":"2026-09-14","about":{"@type":"Thing","name":"Hack The Box (HTB)"},"keywords":"Fuzzing de directorios, Remote Code Execution (RCE)","isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"},"proficiencyLevel":"Medio"}`}</script>
