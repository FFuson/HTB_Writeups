...
<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","headline":"Retired — HTB Writeup Index","name":"Retired","url":"https://rootea.es/en/htb/machines/linux/medio/retired","inLanguage":"en","datePublished":"2022-08-13","dateModified":"2026-08-10","about":{"@type":"Thing","name":"Hack The Box (HTB)"},"keywords":"Local File Inclusion (LFI), Local File Inclusion (LFI), Buffer Overflow (BoF / ROP), Port Forwarding / Pivoting","isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"},"proficiencyLevel":"Medio"}`}</script>
