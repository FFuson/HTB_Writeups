...
| --- | --- | ---: |
| [Apocalyst](/en/htb/machines/linux/medio/apocalyst) | WordPress Exploitation · Information Leakage · Steganography (Stego) · Remote Code Execution (RCE) | 4 |
| [Aragog](/en/htb/machines/linux/medio/aragog) | XML External Entity · WordPress Exploitation | 3 |
| [Backend](/en/htb/machines/linux/medio/backend) | Information Leakage · Remote Code Execution (RCE) | 4 |
| [BackendTwo](/en/htb/machines/linux/medio/backendtwo) | Information Leakage · Remote Code Execution (RCE) | 3 |
| [Bolt](/en/htb/machines/linux/medio/bolt) | Subdomain Enumeration · Information Leakage | 3 |
| [Book](/en/htb/machines/linux/medio/book) | Cross-Site Scripting (XSS) | 3 |
| [Cache](/en/htb/machines/linux/medio/cache) | Information Leakage · SQL Injection · Remote Code Execution (RCE) | 3 |
| [Catch](/en/htb/machines/linux/medio/catch) | Information Leakage · SQL Injection · Remote Code Execution (RCE) | 3 |
| [Celestial](/en/htb/machines/linux/medio/celestial) | Remote Code Execution (RCE) | 3 |
| [Chaos](/en/htb/machines/linux/medio/chaos) | Remote Code Execution (RCE) | 3 |
| [Cronos](/en/htb/machines/linux/medio/cronos) | DNS zone transfer · SQL Injection | 3 |
...
| [Epsilon](/en/htb/machines/linux/medio/epsilon) | Remote Code Execution (RCE) | 3 |
| [Europa](/en/htb/machines/linux/medio/europa) | SQL Injection · Remote Code Execution (RCE) | 4 |
| [Flustered](/en/htb/machines/linux/medio/flustered) | Information Leakage · Remote Code Execution (RCE) | 3 |
| [FluxCapacitor](/en/htb/machines/linux/medio/fluxcapacitor) | Directory fuzzing | 3 |
| [Forge](/en/htb/machines/linux/medio/forge) | Server-Side Request Forgery | 3 |
| [Haircut](/en/htb/machines/linux/medio/haircut) | Server-Side Request Forgery | 4 |
...
| [Jewel](/en/htb/machines/linux/medio/jewel) | Information Leakage · Cracking Hashes (hashcat / John) · Remote Code Execution (RCE) | 3 |
...
| [Meta](/en/htb/machines/linux/medio/meta) | Subdomain Enumeration · Port Forwarding / Pivoting · Remote Code Execution (RCE) | 4 |
...
| [Node](/en/htb/machines/linux/medio/node) | Information Leakage · Cracking Hashes (hashcat / John) · Buffer Overflow (BoF / ROP) · Port Forwarding / Pivoting · SUID binaries | 4 |
| [Noter](/en/htb/machines/linux/medio/noter) | Information Leakage · Directory fuzzing · Remote Code Execution (RCE) | 5 |
| [Obscurity](/en/htb/machines/linux/medio/obscurity) | Information Leakage · Remote Code Execution (RCE) | 4 |
...
| [Ransom](/en/htb/machines/linux/medio/ransom) | Login Bypass (Type Juggling Attack) Decrypting a ZIP file (PlainText Attack -… | 3 |
...
| [Retired](/en/htb/machines/linux/medio/retired) | Local File Inclusion (LFI) · Buffer Overflow (BoF / ROP) · Port Forwarding / Pivoting | 3 |
...
| [Tenet](/en/htb/machines/linux/medio/tenet) | PHP Deserialization Attack Abusing Race Condition | 3 |
| [Tenten](/en/htb/machines/linux/medio/tenten) | WordPress Exploitation · Cracking Hashes (hashcat / John) · Steganography (Stego) | 3 |
| [TheNotebook](/en/htb/machines/linux/medio/thenotebook) | Abusing JWT (Gaining privileges) Abusing Upload File Docker Breakout… | 3 |
| [Time](/en/htb/machines/linux/medio/time) | Server-Side Request Forgery · Remote Code Execution (RCE) | 4 |
| [Timing](/en/htb/machines/linux/medio/timing) | Local File Inclusion (LFI) | 4 |
...
| [Unicode](/en/htb/machines/linux/medio/unicode) | Local File Inclusion (LFI) | 3 |
| [Union](/en/htb/machines/linux/medio/union) | SQL Injection · Remote Code Execution (RCE) | 4 |
...
| [Writer](/en/htb/machines/linux/medio/writer) | Cracking Hashes (hashcat / John) · SQL Injection · Port Forwarding / Pivoting | 4 |
