...
| [Cache](/en/htb/machines/linux/medio/cache) | Access Control / IDOR · Authentication Vulnerabilities · Information Leakage · SQL Injection · Remote Code Execution (RCE) | 4 |
| [Catch](/en/htb/machines/linux/medio/catch) | SSTI (Server-Side Template Injection) · Information Leakage · SQL Injection · Remote Code Execution (RCE) | 4 |
...
| [Union](/en/htb/machines/linux/medio/union) | OS Command Injection · SQL Injection · Remote Code Execution (RCE) | 3 |
