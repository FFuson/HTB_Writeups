...
| [Epsilon](/en/htb/machines/linux/medio/epsilon) | SSTI (Server-Side Template Injection) · Remote Code Execution (RCE) · JSON Web Tokens (JWT) | 3 |
...
| [Haircut](/en/htb/machines/linux/medio/haircut) | Server-Side Request Forgery | 3 |
...
| [Noter](/en/htb/machines/linux/medio/noter) | SSTI (Server-Side Template Injection) · Information Leakage · Directory fuzzing · Remote Code Execution (RCE) · JSON Web Tokens (JWT) | 5 |
| [Obscurity](/en/htb/machines/linux/medio/obscurity) | Information Leakage · Remote Code Execution (RCE) | 4 |
| [October](/en/htb/machines/linux/medio/october) | Buffer Overflow (BoF / ROP) | 4 |
...
| [TheNotebook](/en/htb/machines/linux/medio/thenotebook) | JSON Web Tokens (JWT) | 3 |
...
| [Wall](/en/htb/machines/linux/medio/wall) | Brute Force / Rate-Limit Bypass · SUID binaries · Directory fuzzing · Remote Code Execution (RCE) | 4 |
