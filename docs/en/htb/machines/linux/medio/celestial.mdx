...
<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","headline":"Celestial — HTB Writeup Index","name":"Celestial","url":"https://rootea.es/en/htb/machines/linux/medio/celestial","inLanguage":"en","datePublished":"2018-08-25","dateModified":"2026-06-07","about":{"@type":"Thing","name":"Hack The Box (HTB)"},"keywords":"Insecure Deserialization, Remote Code Execution (RCE)","isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"},"proficiencyLevel":"Medio"}`}</script>
