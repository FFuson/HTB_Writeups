...
description: "PortSwigger Web Security Academy lab: Reflected XSS into a JavaScript string with single quote and backslash escaped. Topic: Cross-Site Scripting (XSS)."
---
...
| 🇬🇧 EN | **z3nsh3ll** | Vídeo | [Open](https://youtu.be/OwcT9ahQlSU) |
...
<div className="rootea-giscus-wrap" data-giscus-term="lab:cross-site-scripting-contexts-javascript-string-single-quote-backslash-escaped" data-giscus-lang="en"></div>
