...
{/* JSONLD:START */}
<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"HowTo","name":"Professional pentest report template","description":"Four-page structure to write a security audit report","inLanguage":"en","url":"https://rootea.es/en/plantilla-informe","step":[{"@type":"HowToStep","name":"Executive summary"},{"@type":"HowToStep","name":"Technical vector"},{"@type":"HowToStep","name":"Privilege escalation"},{"@type":"HowToStep","name":"Remediation"}]}`}</script>
{/* JSONLD:END */}
...
- [Tactical glossary](/en/glosario) — How to write the technical
  section of each vuln.
- [Professional methodology](/en/metodologia) — MITRE ATT&CK,
  PTES phases.
- [Learning resources](/en/recursos) — Teaching platforms and
  reference books.
- [Web recon](/en/recon-web) — How to enumerate without firing
  the WAF.
