...
{/* JSONLD:START */}
<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Modern Red Team operations 2024-2026","description":"State of EDR ecosystem, C2 frameworks and evasion techniques with defensive MITRE Sigma mapping","inLanguage":"en","url":"https://rootea.es/en/red-team-moderno"}`}</script>
{/* JSONLD:END */}
...
- [Tactical glossary](/en/glosario) — Mimikatz, Pass-the-Hash,
  BloodHound.
