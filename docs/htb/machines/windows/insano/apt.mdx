...
<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","headline":"APT — HTB Writeup Index","name":"APT","url":"https://rootea.es/htb/machines/windows/insano/apt","inLanguage":"es","datePublished":"2021-04-10","dateModified":"2026-07-13","about":{"@type":"Thing","name":"Hack The Box (HTB)"},"keywords":"Cracking Hashes (hashcat / John), winPEAS, SMB (139/445)","isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"},"proficiencyLevel":"Insano"}`}</script>
