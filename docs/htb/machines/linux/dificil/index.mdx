...
| [Falafel](/htb/machines/linux/dificil/falafel) | Information Leakage · SQL Injection · Type Juggling / Confusion | 3 |
| [Feline](/htb/machines/linux/dificil/feline) | Information Leakage · Directory / Path Traversal · Port Forwarding / Pivoting · Remote Code Execution (RCE) | 4 |
...
| [Mischief](/htb/machines/linux/dificil/mischief) | Information Leakage · SNMP Enumeration | 5 |
...
| [OverGraph](/htb/machines/linux/dificil/overgraph) | Subdomain Enumeration · Cross-Site Scripting (XSS) · Information Leakage · SQL Injection · Fuzzing de directorios · Server-Side Request Forgery · SUID binaries · Remote Code Execution (RCE) · JSON Web Tokens (JWT) | 3 |
...
| [Player](/htb/machines/linux/dificil/player) | Subdomain Enumeration · Information Leakage · Remote Code Execution (RCE) · JSON Web Tokens (JWT) | 4 |
