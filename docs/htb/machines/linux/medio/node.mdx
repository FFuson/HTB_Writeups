...
<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","headline":"Node — HTB Writeup Index","name":"Node","url":"https://rootea.es/htb/machines/linux/medio/node","inLanguage":"es","datePublished":"2021-06-08","dateModified":"2026-06-29","about":{"@type":"Thing","name":"Hack The Box (HTB)"},"keywords":"Information Leakage, OS Command Injection, Cracking Hashes (hashcat / John), Buffer Overflow (BoF / ROP), Port Forwarding / Pivoting, SUID binaries","isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"},"proficiencyLevel":"Medio"}`}</script>
