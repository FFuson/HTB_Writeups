...
<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","headline":"Inception — HTB Writeup Index","name":"Inception","url":"https://rootea.es/htb/machines/linux/medio/inception","inLanguage":"es","datePublished":"2022-04-04","dateModified":"2026-06-07","about":{"@type":"Thing","name":"Hack The Box (HTB)"},"keywords":"Local File Inclusion (LFI), Local File Inclusion (LFI), Port Forwarding / Pivoting, WebDAV, Fuzzing de directorios","isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"},"proficiencyLevel":"Medio"}`}</script>
