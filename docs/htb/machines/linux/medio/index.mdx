...
| [Devzat](/htb/machines/linux/medio/devzat) | Fuzzing de directorios · Remote Code Execution (RCE) | 4 |
...
| [Noter](/htb/machines/linux/medio/noter) | SSTI (Server-Side Template Injection) · Information Leakage · OS Command Injection · Fuzzing de directorios · Remote Code Execution (RCE) · JSON Web Tokens (JWT) | 4 |
