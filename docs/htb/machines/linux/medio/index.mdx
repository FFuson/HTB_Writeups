...
| [Backend](/htb/machines/linux/medio/backend) | Information Leakage · Remote Code Execution (RCE) | 4 |
| [BackendTwo](/htb/machines/linux/medio/backendtwo) | Information Leakage · Remote Code Execution (RCE) | 3 |
| [Bolt](/htb/machines/linux/medio/bolt) | Subdomain Enumeration · Information Leakage | 3 |
| [Book](/htb/machines/linux/medio/book) | Cross-Site Scripting (XSS) | 3 |
| [Cache](/htb/machines/linux/medio/cache) | Information Leakage · SQL Injection · Remote Code Execution (RCE) | 3 |
| [Catch](/htb/machines/linux/medio/catch) | Information Leakage · SQL Injection · Remote Code Execution (RCE) | 3 |
| [Celestial](/htb/machines/linux/medio/celestial) | Remote Code Execution (RCE) | 3 |
| [Chaos](/htb/machines/linux/medio/chaos) | Remote Code Execution (RCE) | 3 |
| [Cronos](/htb/machines/linux/medio/cronos) | Transferencia de zona DNS · SQL Injection | 3 |
...
| [Epsilon](/htb/machines/linux/medio/epsilon) | Remote Code Execution (RCE) | 3 |
| [Europa](/htb/machines/linux/medio/europa) | SQL Injection · Remote Code Execution (RCE) | 4 |
| [Flustered](/htb/machines/linux/medio/flustered) | Information Leakage · Remote Code Execution (RCE) | 3 |
| [FluxCapacitor](/htb/machines/linux/medio/fluxcapacitor) | Fuzzing de directorios | 3 |
| [Forge](/htb/machines/linux/medio/forge) | Server-Side Request Forgery | 3 |
| [Haircut](/htb/machines/linux/medio/haircut) | Server-Side Request Forgery | 4 |
...
| [Jewel](/htb/machines/linux/medio/jewel) | Information Leakage · Cracking Hashes (hashcat / John) · Remote Code Execution (RCE) | 3 |
...
| [Meta](/htb/machines/linux/medio/meta) | Subdomain Enumeration · Port Forwarding / Pivoting · Remote Code Execution (RCE) | 4 |
...
| [Node](/htb/machines/linux/medio/node) | Information Leakage · Cracking Hashes (hashcat / John) · Buffer Overflow (BoF / ROP) · Port Forwarding / Pivoting · SUID binaries | 4 |
| [Noter](/htb/machines/linux/medio/noter) | Information Leakage · Fuzzing de directorios · Remote Code Execution (RCE) | 5 |
| [Obscurity](/htb/machines/linux/medio/obscurity) | Information Leakage · Remote Code Execution (RCE) | 4 |
...
| [Ransom](/htb/machines/linux/medio/ransom) | Login Bypass (Type Juggling Attack) Decrypting a ZIP file (PlainText Attack -… | 3 |
...
| [Retired](/htb/machines/linux/medio/retired) | Local File Inclusion (LFI) · Buffer Overflow (BoF / ROP) · Port Forwarding / Pivoting | 3 |
...
| [Tenet](/htb/machines/linux/medio/tenet) | PHP Deserialization Attack Abusing Race Condition | 3 |
| [Tenten](/htb/machines/linux/medio/tenten) | WordPress Exploitation · Cracking Hashes (hashcat / John) · Steganography (Stego) | 3 |
| [TheNotebook](/htb/machines/linux/medio/thenotebook) | Abusing JWT (Gaining privileges) Abusing Upload File Docker Breakout… | 3 |
| [Time](/htb/machines/linux/medio/time) | Server-Side Request Forgery · Remote Code Execution (RCE) | 4 |
| [Timing](/htb/machines/linux/medio/timing) | Local File Inclusion (LFI) | 4 |
...
| [Unicode](/htb/machines/linux/medio/unicode) | Local File Inclusion (LFI) | 3 |
| [Union](/htb/machines/linux/medio/union) | SQL Injection · Remote Code Execution (RCE) | 4 |
...
| [Writer](/htb/machines/linux/medio/writer) | Cracking Hashes (hashcat / John) · SQL Injection · Port Forwarding / Pivoting | 4 |
