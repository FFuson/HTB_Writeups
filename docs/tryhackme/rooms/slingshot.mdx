...
| Tiempo medio | 60 min |
| Usuarios | 10.671 |
| Sala oficial | [Abrir](https://tryhackme.com/room/slingshot) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/slingshot) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-slingshot" data-giscus-lang="es"></div>

_Última actualización: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Slingshot","headline":"Slingshot — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/slingshot","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
