...
| Usuarios | 23.345 |
| Sala oficial | [Abrir](https://tryhackme.com/room/breachingad) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/breachingad) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-breachingad" data-giscus-lang="es"></div>

_Última actualización: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Breaching Active Directory","headline":"Breaching Active Directory — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/breachingad","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
