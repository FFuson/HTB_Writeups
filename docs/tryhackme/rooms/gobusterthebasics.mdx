...
| Tiempo medio | 60 min |
| Usuarios | 59.770 |
| Sala oficial | [Abrir](https://tryhackme.com/room/gobusterthebasics) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/gobusterthebasics) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-gobusterthebasics" data-giscus-lang="es"></div>

_Última actualización: 2026-05-09_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Gobuster: The Basics","headline":"Gobuster: The Basics — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/gobusterthebasics","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
