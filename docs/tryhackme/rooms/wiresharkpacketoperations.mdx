...
| Tiempo medio | 60 min |
| Usuarios | 71.516 |
| Sala oficial | [Abrir](https://tryhackme.com/room/wiresharkpacketoperations) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/wiresharkpacketoperations) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-wiresharkpacketoperations" data-giscus-lang="es"></div>

_Última actualización: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Wireshark: Packet Operations","headline":"Wireshark: Packet Operations — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/wiresharkpacketoperations","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
