...
| Tiempo medio | 45 min |
| Usuarios | 32.750 |
| Sala oficial | [Abrir](https://tryhackme.com/room/source) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/source) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-source" data-giscus-lang="es"></div>

_Última actualización: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Source","headline":"Source — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/source","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Challenge"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
