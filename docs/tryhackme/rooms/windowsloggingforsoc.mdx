...
| Tiempo medio | 60 min |
| Usuarios | 27.552 |
| Sala oficial | [Abrir](https://tryhackme.com/room/windowsloggingforsoc) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/windowsloggingforsoc) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-windowsloggingforsoc" data-giscus-lang="es"></div>

_Última actualización: 2026-05-09_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Windows Logging for SOC","headline":"Windows Logging for SOC — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/windowsloggingforsoc","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
