...
| Tiempo medio | 60 min |
| Usuarios | 43.519 |
| Sala oficial | [Abrir](https://tryhackme.com/room/solar) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/solar) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-solar" data-giscus-lang="es"></div>

_Última actualización: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Solar, exploiting log4j","headline":"Solar, exploiting log4j — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/solar","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
