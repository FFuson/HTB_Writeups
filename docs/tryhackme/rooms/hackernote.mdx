...
| Tiempo medio | 75 min |
| Usuarios | 15.373 |
| Sala oficial | [Abrir](https://tryhackme.com/room/hackernote) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/hackernote) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-hackernote" data-giscus-lang="es"></div>

_Última actualización: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"hackerNote","headline":"hackerNote — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/hackernote","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
