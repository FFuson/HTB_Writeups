...
| Tiempo medio | 40 min |
| Usuarios | 156.485 |
| Sala oficial | [Abrir](https://tryhackme.com/room/unifiedkillchain) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/unifiedkillchain) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-unifiedkillchain" data-giscus-lang="es"></div>

_Última actualización: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Unified Kill Chain","headline":"Unified Kill Chain — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/unifiedkillchain","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
