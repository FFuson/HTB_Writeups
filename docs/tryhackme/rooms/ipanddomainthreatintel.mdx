...
| Tiempo medio | 60 min |
| Usuarios | 10.259 |
| Sala oficial | [Abrir](https://tryhackme.com/room/ipanddomainthreatintel) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/ipanddomainthreatintel) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-ipanddomainthreatintel" data-giscus-lang="es"></div>

_Última actualización: 2026-05-09_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"IP and Domain Threat Intel","headline":"IP and Domain Threat Intel — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/ipanddomainthreatintel","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
