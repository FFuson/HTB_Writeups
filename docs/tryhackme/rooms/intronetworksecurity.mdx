...
| Tiempo medio | 90 min |
| Usuarios | 161.240 |
| Sala oficial | [Abrir](https://tryhackme.com/room/intronetworksecurity) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/intronetworksecurity) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-intronetworksecurity" data-giscus-lang="es"></div>

_Última actualización: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Network Security","headline":"Network Security — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/intronetworksecurity","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
