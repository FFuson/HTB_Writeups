...
| Tiempo medio | 60 min |
| Usuarios | 122.829 |
| Sala oficial | [Abrir](https://tryhackme.com/room/windowspowershell) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/windowspowershell) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-windowspowershell" data-giscus-lang="es"></div>

_Última actualización: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Windows PowerShell","headline":"Windows PowerShell — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/windowspowershell","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
