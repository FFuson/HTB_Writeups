...
| Tiempo medio | 60 min |
| Usuarios | 14.190 |
| Sala oficial | [Abrir](https://tryhackme.com/room/retracted) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/retracted) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-retracted" data-giscus-lang="es"></div>

_Última actualización: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Retracted","headline":"Retracted — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/retracted","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
