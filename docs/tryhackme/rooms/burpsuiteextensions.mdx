...
| Tiempo medio | 30 min |
| Usuarios | 62.500 |
| Sala oficial | [Abrir](https://tryhackme.com/room/burpsuiteextensions) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/burpsuiteextensions) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-burpsuiteextensions" data-giscus-lang="es"></div>

_Última actualización: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Burp Suite: Extensions","headline":"Burp Suite: Extensions — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/burpsuiteextensions","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
