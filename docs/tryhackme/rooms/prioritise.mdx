...
| Tiempo medio | 25 min |
| Usuarios | 6.337 |
| Sala oficial | [Abrir](https://tryhackme.com/room/prioritise) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/prioritise) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-prioritise" data-giscus-lang="es"></div>

_Última actualización: 2026-05-09_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Prioritise","headline":"Prioritise — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/prioritise","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Challenge"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
