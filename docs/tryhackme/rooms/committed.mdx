...
| Tiempo medio | 20 min |
| Usuarios | 7.879 |
| Sala oficial | [Abrir](https://tryhackme.com/room/committed) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/committed) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-committed" data-giscus-lang="es"></div>

_Última actualización: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Committed","headline":"Committed — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/committed","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Challenge"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
