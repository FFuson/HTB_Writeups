...
| Tiempo medio | 30 min |
| Usuarios | 48.059 |
| Sala oficial | [Abrir](https://tryhackme.com/room/powershell) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/powershell) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-powershell" data-giscus-lang="es"></div>

_Última actualización: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Hacking with PowerShell","headline":"Hacking with PowerShell — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/powershell","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
