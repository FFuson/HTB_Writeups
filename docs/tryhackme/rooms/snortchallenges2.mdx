...
| Tiempo medio | 90 min |
| Usuarios | 41.471 |
| Sala oficial | [Abrir](https://tryhackme.com/room/snortchallenges2) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/snortchallenges2) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-snortchallenges2" data-giscus-lang="es"></div>

_Última actualización: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Snort Challenge - Live Attacks","headline":"Snort Challenge - Live Attacks — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/snortchallenges2","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Challenge"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
