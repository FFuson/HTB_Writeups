...
| Tiempo medio | 60 min |
| Usuarios | 345 |
| Sala oficial | [Abrir](https://tryhackme.com/room/xdrlateralmovement) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/xdrlateralmovement) |
...
[Active Directory](/skills/active-directory) · [Remote Code Execution (RCE)](/skills/rce)
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-xdrlateralmovement" data-giscus-lang="es"></div>

_Última actualización: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"XDR: Lateral Movement","headline":"XDR: Lateral Movement — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/xdrlateralmovement","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
