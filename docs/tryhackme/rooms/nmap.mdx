...
| Tiempo medio | 60 min |
| Usuarios | 96.635 |
| Sala oficial | [Abrir](https://tryhackme.com/room/nmap) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/nmap) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-nmap" data-giscus-lang="es"></div>

_Última actualización: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Nmap: The Basics","headline":"Nmap: The Basics — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/nmap","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
