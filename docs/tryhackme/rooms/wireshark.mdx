...
| Tiempo medio | 60 min |
| Usuarios | 97.930 |
| Sala oficial | [Abrir](https://tryhackme.com/room/wireshark) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/wireshark) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-wireshark" data-giscus-lang="es"></div>

_Última actualización: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Wireshark 101","headline":"Wireshark 101 — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/wireshark","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
