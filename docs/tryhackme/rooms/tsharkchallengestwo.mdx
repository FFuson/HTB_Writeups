...
| Tiempo medio | 60 min |
| Usuarios | 16.334 |
| Sala oficial | [Abrir](https://tryhackme.com/room/tsharkchallengestwo) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/tsharkchallengestwo) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-tsharkchallengestwo" data-giscus-lang="es"></div>

_Última actualización: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"TShark Challenge II: Directory","headline":"TShark Challenge II: Directory — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/tsharkchallengestwo","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Challenge"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
