...
| Usuarios | 7.549 |
| Sala oficial | [Abrir](https://tryhackme.com/room/persistingad) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/persistingad) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-persistingad" data-giscus-lang="es"></div>

_Última actualización: 2026-05-09_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Persisting Active Directory","headline":"Persisting Active Directory — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/persistingad","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
