...
| Tiempo medio | 75 min |
| Usuarios | 23.769 |
| Sala oficial | [Abrir](https://tryhackme.com/room/brainstorm) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/brainstorm) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-brainstorm" data-giscus-lang="es"></div>

_Última actualización: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Brainstorm","headline":"Brainstorm — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/brainstorm","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Challenge"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
