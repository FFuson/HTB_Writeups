...
| Tiempo medio | 60 min |
| Usuarios | 538.139 |
| Sala oficial | [Abrir](https://tryhackme.com/room/searchskills) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/searchskills) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-searchskills" data-giscus-lang="es"></div>

_Última actualización: 2026-05-09_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Search Skills","headline":"Search Skills — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/searchskills","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
