...
| Tiempo medio | 20 min |
| Usuarios | 3.623 |
| Sala oficial | [Abrir](https://tryhackme.com/room/hfb1cipherssecretmessage) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/hfb1cipherssecretmessage) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-hfb1cipherssecretmessage" data-giscus-lang="es"></div>

_Última actualización: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Cipher's Secret Message","headline":"Cipher's Secret Message — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/hfb1cipherssecretmessage","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Challenge"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
