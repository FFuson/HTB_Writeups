...
| Tiempo medio | 60 min |
| Usuarios | 57.852 |
| Sala oficial | [Abrir](https://tryhackme.com/room/shellsoverview) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/shellsoverview) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-shellsoverview" data-giscus-lang="es"></div>

_Última actualización: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Shells Overview","headline":"Shells Overview — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/shellsoverview","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
