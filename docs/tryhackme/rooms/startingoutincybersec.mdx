...
| Tiempo medio | 10 min |
| Usuarios | 454.719 |
| Sala oficial | [Abrir](https://tryhackme.com/room/startingoutincybersec) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/startingoutincybersec) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-startingoutincybersec" data-giscus-lang="es"></div>

_Última actualización: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Starting Out In Cyber Sec","headline":"Starting Out In Cyber Sec — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/startingoutincybersec","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
