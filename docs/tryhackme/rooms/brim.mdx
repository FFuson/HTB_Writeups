...
| Usuarios | 31.938 |
| Sala oficial | [Abrir](https://tryhackme.com/room/brim) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/brim) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-brim" data-giscus-lang="es"></div>

_Última actualización: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Brim","headline":"Brim — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/brim","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
