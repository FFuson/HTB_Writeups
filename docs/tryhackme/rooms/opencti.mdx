...
| Tiempo medio | 60 min |
| Usuarios | 58.695 |
| Sala oficial | [Abrir](https://tryhackme.com/room/opencti) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/opencti) |
| 🇬🇧 EN | **stuffy24** | Vídeo | [Abrir](https://youtu.be/qgqtFoyLLUo) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-opencti" data-giscus-lang="es"></div>

_Última actualización: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"OpenCTI","headline":"OpenCTI — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/opencti","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
