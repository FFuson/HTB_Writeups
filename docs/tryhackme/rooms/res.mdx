...
| Tiempo medio | 30 min |
| Usuarios | 15.278 |
| Sala oficial | [Abrir](https://tryhackme.com/room/res) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/res) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-res" data-giscus-lang="es"></div>

_Última actualización: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Res","headline":"Res — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/res","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Challenge"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
