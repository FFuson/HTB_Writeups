...
| Tiempo medio | 60 min |
| Usuarios | 29.315 |
| Sala oficial | [Abrir](https://tryhackme.com/room/zeekbroexercises) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/zeekbroexercises) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-zeekbroexercises" data-giscus-lang="es"></div>

_Última actualización: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Zeek Exercises","headline":"Zeek Exercises — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/zeekbroexercises","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Challenge"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
