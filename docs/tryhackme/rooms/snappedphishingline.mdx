...
| Tiempo medio | 60 min |
| Usuarios | 36.150 |
| Sala oficial | [Abrir](https://tryhackme.com/room/snappedphishingline) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/snappedphishingline) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-snappedphishingline" data-giscus-lang="es"></div>

_Última actualización: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Snapped Phish-ing Line","headline":"Snapped Phish-ing Line — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/snappedphishingline","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Challenge"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
