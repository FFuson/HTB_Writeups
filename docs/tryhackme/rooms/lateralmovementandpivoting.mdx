...
| Tiempo medio | 45 min |
| Usuarios | 15.633 |
| Sala oficial | [Abrir](https://tryhackme.com/room/lateralmovementandpivoting) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/lateralmovementandpivoting) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-lateralmovementandpivoting" data-giscus-lang="es"></div>

_Última actualización: 2026-05-09_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Lateral Movement and Pivoting","headline":"Lateral Movement and Pivoting — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/lateralmovementandpivoting","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
