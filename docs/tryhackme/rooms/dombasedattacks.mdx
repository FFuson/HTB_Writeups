...
| Tiempo medio | 60 min |
| Usuarios | 9.412 |
| Sala oficial | [Abrir](https://tryhackme.com/room/dombasedattacks) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/dombasedattacks) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-dombasedattacks" data-giscus-lang="es"></div>

_Última actualización: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"DOM-Based Attacks","headline":"DOM-Based Attacks — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/dombasedattacks","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
