...
| Tiempo medio | 60 min |
| Usuarios | 8.735 |
| Sala oficial | [Abrir](https://tryhackme.com/room/paymentcollectors) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/paymentcollectors) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-paymentcollectors" data-giscus-lang="es"></div>

_Última actualización: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Hunt Me I: Payment Collectors","headline":"Hunt Me I: Payment Collectors — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/paymentcollectors","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
