...
| Tiempo medio | 60 min |
| Usuarios | 3.172 |
| Sala oficial | [Abrir](https://tryhackme.com/room/adauthenticatedenumeration) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/adauthenticatedenumeration) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-adauthenticatedenumeration" data-giscus-lang="es"></div>

_Última actualización: 2026-05-09_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"AD: Authenticated Enumeration","headline":"AD: Authenticated Enumeration — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/adauthenticatedenumeration","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
