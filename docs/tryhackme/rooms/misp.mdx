...
| Tiempo medio | 60 min |
| Usuarios | 64.934 |
| Sala oficial | [Abrir](https://tryhackme.com/room/misp) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/misp) |
| 🇬🇧 EN | **stuffy24** | Vídeo | [Abrir](https://youtu.be/obdafltUI_k) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-misp" data-giscus-lang="es"></div>

_Última actualización: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"MISP","headline":"MISP — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/misp","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
