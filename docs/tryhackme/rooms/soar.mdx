...
| Tiempo medio | 60 min |
| Usuarios | 35.341 |
| Sala oficial | [Abrir](https://tryhackme.com/room/soar) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/soar) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-soar" data-giscus-lang="es"></div>

_Última actualización: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"Introduction to SOAR","headline":"Introduction to SOAR — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/soar","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
