...
| Tiempo medio | 60 min |
| Usuarios | 48.858 |
| Sala oficial | [Abrir](https://tryhackme.com/room/capabasics) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/capabasics) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-capabasics" data-giscus-lang="es"></div>

_Última actualización: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"CAPA: The Basics","headline":"CAPA: The Basics — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/capabasics","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
