...
| Usuarios | 19.444 |
| Sala oficial | [Abrir](https://tryhackme.com/room/tsharkthebasics) |
...
| --- | --- | --- | --- |
| 🇬🇧 EN | **TryHackMe** | Lab oficial | [Abrir](https://tryhackme.com/room/tsharkthebasics) |
...
<div className="rootea-giscus-wrap" data-giscus-term="thm:tryhackme-tsharkthebasics" data-giscus-lang="es"></div>

_Última actualización: 2026-05-08_

<script type="application/ld+json">{`{"@context":"https://schema.org","@type":"TechArticle","name":"TShark: The Basics","headline":"TShark: The Basics — TryHackMe room index","url":"https://rootea.es/tryhackme/rooms/tsharkthebasics","inLanguage":"es","about":[{"@type":"Thing","name":"TryHackMe"},{"@type":"Thing","name":"Walkthrough"}],"isPartOf":{"@type":"WebSite","name":"rootea.es","url":"https://rootea.es"},"author":{"@type":"Organization","name":"rootea.es"}}`}</script>
