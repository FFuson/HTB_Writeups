...
from scripts import (  # noqa: E402
    ...
    fetch_machines,
    fetch_portswigger,
    fetch_portswigger_authors,
    fetch_tryhackme,
    fetch_tryhackme_authors,
    find_skills,
    find_writeups,
    generate_mdx,
    track_changes,
...
PHASES = [
    ...
    ("fetch_portswigger_authors", fetch_portswigger_authors.main),
    ("fetch_tryhackme", fetch_tryhackme.main),
    ("fetch_tryhackme_authors", fetch_tryhackme_authors.main),
